...
<div class="box-bd">
                    ...
                    <div class="box-bd">
                        <dl class="checkout-goods-list">
                            ...
                            <c:forEach items="${cartItemList}" var="item">
                                ...
                                <div class="prodList">
                                    <dt class="clearfix">
                                        <span class="col col-1">${item.prodName}&nbsp(${item.skuValueList})
                                        </span>
                                    <span class="col col-2">${item.price} </span>
                                    <span class="col col-3">${item.num} </span>
                                    <span class="col col-4">${item.price*item.num}</span>
                                    </dt>
                                </div>
    ...
    <!--S 保障计划 产品选择弹框 -->
                ...
                <div class="checkout-confirm">
                     ...
                     <a href="/cart" class="btn btn-lineDakeLight btn-back-cart">返回购物车</a>
